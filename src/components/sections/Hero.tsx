...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      {/* ========== MOBILE ========== */}
      <div className="relative flex min-h-[140vh] flex-col justify-end md:hidden">
        {/* Imagem full-bleed */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent 0%, transparent 45%, rgba(0,0,0,0.45) 65%, rgba(0,0,0,0.92) 100%)",
          }}
        />
